...
const x = function( id,
opciones,
...otros ) {if(!(typeof id === 'string')) throw new Error("Error en fichero [-] en posición [136-166=5:5-5:35] cuando: " + "Compruebo que id es tipo texto");
...
let y = 0;
try {throw new Error( "Un mensaje" );} catch(error) {
y = 1;}
