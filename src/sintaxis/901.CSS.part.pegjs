...
stylesheet
  = charset:(CHARSET_SYM STRING ";")? (S / CDO / CDC)*
    ...
    rules:((ruleset / media / page / Intercalacion_de_plantilla) (CDO S* / CDC S*)*)*
    {
      return {
        type: "StyleSheet",
...
property
  = name:(IDENT/Intercalacion_de_plantilla) S* { return name; }
...
declaration
  = (declaration_sub1 / declaration_sub2)

declaration_sub2 = Intercalacion_de_plantilla { return text() }
declaration_sub1 = name:property ':' S* value:expr prio:prio? {
      return {
        type: "Declaration",
        name: name,
        value: value,
...
expr
  = (expr_sub1 / expr_sub2)
expr_sub1 = head:term tail:(operator? term)* { return buildExpression(head, tail); }
expr_sub2 = Intercalacion_de_plantilla { return text() }
