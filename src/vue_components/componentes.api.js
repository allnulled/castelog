...
Castelog.metodos.un_componente_vue2("ControlParaTexto", "<input class=\"ControlParaTexto Control PuntoDeControl\" type=\"text\" v-model=\"internal_value\" :key=\"'control_para_texto_' + uuid\" />", function(component) {return { props:{ uuid:{ type:String,
default:function() {try {
return Castelog.metodos.un_texto_aleatorio(10, undefined);
} catch(error) {
console.log(error);
...
Castelog.metodos.un_componente_vue2("ControlParaEnvio", "<ControlParaBoton :al-clicar=\"() => enviar_formulario()\">"
 + "            <slot></slot>"
 + "        </ControlParaBoton>", function(component) {return { data:function() {try {
return { 
};
} catch(error) {
console.log(error);
...
Castelog.metodos.un_componente_vue2("ControlParaColor", "<input class=\"ControlParaColor Control PuntoDeControl\" type=\"color\" v-model=\"internal_value\" :key=\"'control_para_color_' + uuid\" />", function(component) {return { props:{ uuid:{ type:String,
default:function() {try {
return Castelog.metodos.un_texto_aleatorio(10, undefined);
} catch(error) {
console.log(error);
...
Castelog.metodos.un_componente_vue2("ControlParaContrasenya", "<input class=\"ControlParaContrasenya Control PuntoDeControl\" type=\"password\" v-model=\"internal_value\" :key=\"'control_para_contrasenya_' + uuid\" />", function(component) {return { props:{ uuid:{ type:String,
default:function() {try {
return Castelog.metodos.un_texto_aleatorio(10, undefined);
} catch(error) {
console.log(error);
